...
#     # Đảm bảo y và y_hat là mảng 1D
#     if isinstance(y, torch.Tensor):
#         y = y.view(-1).numpy() if y.numel() == 1 else y.numpy()
#     if isinstance(y_hat, torch.Tensor):
#         y_hat = y_hat.view(-1).numpy() if y_hat.numel() == 1 else y_hat.numpy()
    
#     # Nếu là scalar, chuyển thành mảng 1D
#     if np.isscalar(y):
#         y = np.array([y])
