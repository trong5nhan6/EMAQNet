...
# D:\VS_code\AQNet\Modules\SingleOutput\data\multimodal\samples_multimodal_3polls.csv
# Modules\SingleOutput\data\multimodal\train_edited_data_full.csv rename_station_train_edited_data_full
...
parser.add_argument('--batch_size', default=10, type=int) #default=50
    ...
    with mlflow.start_run(experiment_id=experiment_id):
        ...
        for epoch in range(config.epochs):
            ...
            for idx, sample in enumerate(dataloader_train):
                ...
                # if weather:            
                tabular = [sample["Altitude"], Onehot1, Onehot2, Onehot3, Onehot4, Onehot5, Onehot6,
                    Onehot7, Onehot8, sample["tavg"], sample["prcp"], sample["wspd"], sample["pres"], sample["tsun"]]
                # else: 
                #     tabular = [sample["Altitude"], Onehot1, Onehot2, Onehot3, Onehot4, Onehot5, Onehot6,
                #         Onehot7, Onehot8]
